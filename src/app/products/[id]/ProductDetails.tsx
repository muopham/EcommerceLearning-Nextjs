...
export default function ProductDetails({ product }: ProductDetailsProps) {
  ...
  const thumbnails = [
    product.imageUrl,
    "https://images.unsplash.com/photo-1572536147248-ac59a8abfa4b?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",
    "https://images.unsplash.com/photo-1628116709703-c1c9ad550d36?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",
        ...
        <Tabs defaultValue="description">
          ...
          <TabsContent value="description" className="py-6">
            ...
            <p className="text-gray-600">
              The ergonomic design provides comfort for extended use, while the
              premium materials ensure durability and style. Connect easily to
              your devices for a stable, high-quality experience.
            </p>
          </TabsContent>
